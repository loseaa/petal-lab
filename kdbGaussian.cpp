...
// copy constructor
kdbGaussian::kdbGaussian(const kdbGaussian& l)
  : useMean4Miss_(l.useMean4Miss_), discretisingStream_(l.discretisingStream_)
{
  name_ = l.name_;
  k_ = l.k_;
  noOrigCatAtts_ = 0;
...
// make a new copy
learner* kdbGaussian::clone() const {
  return new kdbGaussian(*this);
}
