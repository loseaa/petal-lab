...
// copy constructor
kdbSelectiveClean::kdbSelectiveClean(const kdbSelectiveClean& l)
{
  name_ = l.name_;
  k_ = l.k_;
...
// make a new copy
learner* kdbSelectiveClean::clone() const {
  return new kdbSelectiveClean(*this);
}
