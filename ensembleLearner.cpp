...
EnsembleLearner::EnsembleLearner(const EnsembleLearner& l) 
  : learnerName_(l.learnerName_), learnerArgv_(l.learnerArgv_), learnerArgEnd_(l.learnerArgEnd_), size_(l.size_), useMajorityVoting_(l.useMajorityVoting_)
{
  name_ = l.name_;
}

learner* EnsembleLearner::clone() const {
  return new EnsembleLearner(*this);
}
