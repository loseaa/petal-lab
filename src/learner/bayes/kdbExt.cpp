...
kdbExt::kdbExt(char*const*& argv, char*const* end) {
  ...
  trainSize_ = 0;
  sampleSize_ = 50;
  //srand(sampleSize_); // GIW - commented out - I think that this is seeding the wrong random number generator
...
// copy constructor
kdbExt::kdbExt(const kdbExt& l)
{
  name_ = l.name_;
  k_ = l.k_;
  tan_ = l.tan_;
  randomOrder_ = l.randomOrder_;
  randomParents_ = l.randomParents_;
  chisq_ = l.chisq_;
  holm_ = l.holm_;
  chisqParents_ = l.chisqParents_;
  bestLinks_ = l.bestLinks_;
  orderByValue_ = l.orderByValue_;
  discrimVals_ = l.discrimVals_;
  selective_ = l.selective_;
  ...
  selectiveSampling_ = l.selectiveSampling_;
  su_ = l.su_;
  csu_ = l.csu_;    
  orderBycmi_ = l.orderBycmi_;
  cmiParents_ = l.cmiParents_;
  minCount_ = l.minCount_;
  trainSize_ = l.trainSize_;
  sampleSize_ = l.sampleSize_;
  //srand(sampleSize_); // GIW - commented out - I think that this is seeding the wrong random number generator
}

// make a new copy
learner* kdbExt::clone() const {
  return new kdbExt(*this);
}
