...
DTree::DTree(const DTree& l) 
  : trainingParams_(l.trainingParams_), classificationParams_(l.classificationParams_), trainingIsFinished_(false), root_(NULL)
{
  name_ = l.name_;
}

learner* DTree::clone() const {
