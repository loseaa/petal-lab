...
BaggedLearner::BaggedLearner(const BaggedLearner& l) {
  name_ = l.name_;
  useMajorityVoting_ = l.useMajorityVoting_;
  size_ = l.size_;
  learnerName_ = l.learnerName_;
  learnerArgv_ = l.learnerArgv_;
  learnerArgEnd_ = l.learnerArgEnd_;
}

learner* BaggedLearner::clone() const {
  return new BaggedLearner(*this);
}
